...
/*   Updated: 2023/04/19 22:08:52 by wlahyani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	down_right_rays(t_data *img, double *x)
{
	...
	if (ray2 && ray6 > ray2)
		dala(img, ray2, x, 3, rx * img->we.w);
	else
		dala(img, ray6, x, 4, ry * img->so.w);
}
